...
class CustomQwen3(Qwen3ForCausalLM):
    ...
    def forward(
        ...
        **kwargs: Unpack[KwargsForCausalLM],
        ...
        print(logits.shape)
        # 获取topk的概率和id
        prob, token_id = LogitsLibrary.topk(logits[:,:-1,:], 4, input_ids[:, 1:])
        # 按照格式化打印
        LogitsLibrary.print_topk(prob, token_id, self.tokenizer)
        print(__file__)
        exit()
...
# 注册模型本体
def register_model():
    AutoConfig.register("CustomQwen3", CustomQwen3Config)  # 别名可选
